...
#SBATCH --output=%u.evaluate   # Log file location with meaningful name
...
lora_weights="lora_weight/LLaMA2-7B-Chat/crow_consistency"

# Use empty string to evaluate base model without LoRA
# lora_weights=""

# Common parameters for both runs
common_params="--dataset coqa --parallel_datasets  \
    --model $model \
